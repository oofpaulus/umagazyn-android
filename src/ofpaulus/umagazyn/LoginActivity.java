...
import ofpaulus.umagazyn.synchronization.DownloadDB;
...
public class LoginActivity extends Activity implements LoaderCallbacks<Cursor>, LoginCallback{
	...
	protected void onSaveInstanceState(Bundle outState) {
		outState.putString("sToken", securityToken);
	...
	protected void onRestoreInstanceState(Bundle savedInstanceState) {
		...
		securityToken = savedInstanceState.getString("sToken");
	...
	public void attemptLogin() {
		...
		if (cancel) {
			...
			serverConnector.execute(params);
	...
	public void switchToMainActivity()
	{
		...
		newIntent.putExtra("securityToken", securityToken);
